...
cp $hql_file_placeholder $hql_file_updated

sed  "s|<<jar_location>>|$jar_file|g" $hql_file_updated > $temp_hql_filename
cat $temp_hql_filename > $hql_file_updated

sed  "s|<<delimeter>>|$delimeter|g" $hql_file_updated > $temp_hql_filename
cat $temp_hql_filename > $hql_file_updated

sed  "s|<<input_table_name>>|$input_table_name|g" $hql_file_updated > $temp_hql_filename
cat $temp_hql_filename > $hql_file_updated
